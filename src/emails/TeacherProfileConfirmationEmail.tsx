...
interface TeacherProfileConfirmationEmailProps {
  name: string
  email: string
  profileId: string
}
          ...
          <Container className="mx-auto p-4 max-w-[600px]">
            <Section className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <Section className="px-8 py-6">
                ...
                <Text className="text-gray-700 text-base">
                  Thank you for updating your teacher profile information. Your profile has been successfully updated in
                  our system. This information will be used to showcase your expertise and qualifications to students
                  and parents.
                </Text>
                <Text className="text-gray-700 text-base">
                  Your profile ID is:{" "}
                ...
                <Section className="bg-indigo-50 p-6 rounded-lg border border-indigo-100">
                  ...
                  <Text className="text-gray-700 text-sm mt-2">
                    • Your profile includes your personal information, educational background, and teaching experience
                  </Text>
                  <Text className="text-gray-700 text-sm">
                    • Your teaching philosophy is now visible to students and parents
                  </Text>
                  <Text className="text-gray-700 text-sm">
                    • Your profile photo has been updated and will be displayed on the school website
                  </Text>
                  <Text className="text-gray-700 text-sm">
                    • You can update your profile information at any time through the teacher portal
                  </Text>
                </Section>
                ...
                <Section className="text-center mt-8">
                  <Button
                    ...
                    href={`${process.env.NEXT_PUBLIC_APP_URL}/teacher/profile/view?id=${profileId}`}
                  >
                    View Your Profile
                  </Button>
                </Section>
                ...
                <Text className="text-gray-700 text-base mt-6">
                  ...
                  teacher portal and update your information at any time.
                </Text>
              </Section>
