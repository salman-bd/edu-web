          ...
          <Container className="mx-auto p-4 max-w-[600px]">
            <Section className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <Section className="p-8 text-center">
                ...
                />
                <Heading className="text-gray-600 text-2xl font-bold m-0">Password Reset Request</Heading>
                <Text className="text-indigo-600 text-base mt-2">Follow the instructions to reset your password</Text>
              </Section>
