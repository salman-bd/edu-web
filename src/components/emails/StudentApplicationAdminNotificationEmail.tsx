...
export default function StudentApplicationAdminNotificationEmail({
  applicantName,
  applicantEmail,
  subject,
  applicationId,
            ...
            <Section className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <Section className="px-8 py-6">
                <Text className="text-gray-700 text-base">
                  A new student application has been submitted to the admission processing system.
                </Text>
                ...
                <Section className="text-center mt-6">
                  <Button
                    ...
                    href={`${process.env.NEXT_PUBLIC_APP_URL}/application/admin/student?id=${applicationId}`}
                  >
                    Review Application
                  </Button>
                </Section>
              ...
              <Section className="bg-gray-50 px-8 py-4 text-center">
                ...
                <Text className="text-gray-500 text-xs">This is an automated notification from the admission processing system.</Text>
              </Section>
            </Section>
          </Container>
        </Body>
