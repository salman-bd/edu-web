...
import { MailIcon, ContactIcon, SchoolIcon, VerifiedIcon, CircleAlert, GraduationCap, CalendarCheck, CalendarClock, Calendar, School2, Medal, Loader2, } from "lucide-react"


export function StudentProfile(profileData) {
      ...
      <CardContent>
        <div className="flex flex-col">
          <div className='text-gray-800'>
            ...
            <div className='flex flex-row gap-2'>
            <CalendarClock />
              <p className=" mb-4"><strong className='text-gray-950'>Age: </strong>{data.birthDate}</p>
            </div>
            <hr />
            <br />
          </div>
