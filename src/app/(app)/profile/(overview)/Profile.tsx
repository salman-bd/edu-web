...
import { fetchUserProfileData } from '@/lib/fetchData'  
...
export default function Profile() {  
  ...
  console.log("User session data: ", userEmail);
  ...
  useEffect(() => {  
    const fetchData = async () => {  
      if (userEmail) {  
        try {  
          const response = await fetchUserProfileData(userEmail); 
          console.log("Response from profile data fetching: ", response);
