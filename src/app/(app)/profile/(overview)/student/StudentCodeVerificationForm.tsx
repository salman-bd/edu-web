...
export function StudentCodeVerificationForm() {
  ...
  const handleVerifyCode = async () => {
    ...
    if (code === 'STU-CSC003') {  
      ...
      // Construct query string URL manually  
      router.push(`/profile/student/profile-completion?affiliated=${encodeURIComponent(affiliated)}`);
       
    } else if (code === ''){
      setError('You have not entered the student access code. Please try again.')
    } else {
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Enter the student access code provided by your institution to verify your status and access student resources.
        </CardDescription>
      </CardHeader>
      <CardContent>
