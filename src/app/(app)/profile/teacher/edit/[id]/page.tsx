...
import TeacherProfileEditForm from "@/components/profile/TeacherProfileEditForm"
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      {isSubmitted ? (
        ...
        <TeacherProfileEditForm profileId={id?.toString()} onSuccess={handleSubmitSuccess} />
      )}
    </div>
  )
}
